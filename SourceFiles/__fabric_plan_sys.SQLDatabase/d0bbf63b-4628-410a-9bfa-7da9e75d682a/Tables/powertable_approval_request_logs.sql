CREATE TABLE [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[powertable_approval_request] ([id])
);
