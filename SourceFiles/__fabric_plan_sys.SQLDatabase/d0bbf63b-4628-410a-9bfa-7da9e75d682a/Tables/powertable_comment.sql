CREATE TABLE [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[powertable_source] ([id])
);
