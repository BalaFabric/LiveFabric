CREATE TABLE [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[data_input_column] (
    ...
    CONSTRAINT [FK_2f2ba9690ea788805bf78ae17a1] FOREIGN KEY ([visualId]) REFERENCES [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[visual] ([id])
);
