CREATE TABLE [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[visual] ([id])
);
