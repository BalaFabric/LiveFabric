CREATE TABLE [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[powertable_source] ([id])
);
