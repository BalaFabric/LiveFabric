CREATE TABLE [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[powertable_source] ([id])
);
