CREATE TABLE [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[powertable_source] ([id])
);
