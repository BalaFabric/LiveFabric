CREATE TABLE [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[visual] ([id])
);
