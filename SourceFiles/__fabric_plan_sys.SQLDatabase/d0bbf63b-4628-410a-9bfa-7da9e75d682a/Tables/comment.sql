CREATE TABLE [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[visual] ([id]) ON DELETE CASCADE
);
