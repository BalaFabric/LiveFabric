CREATE TABLE [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[ib_query_writeback_destination]([queryId] ASC);
