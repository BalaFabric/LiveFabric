CREATE TABLE [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[powertable_automation_jobs] ([id])
);
