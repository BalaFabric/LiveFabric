CREATE TABLE [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[powertable_approval] ([id])
);
