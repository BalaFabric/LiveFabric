                          ...
                          CREATE PROCEDURE [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [d0bbf63b-4628-410a-9bfa-7da9e75d682a].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [d0bbf63b-4628-410a-9bfa-7da9e75d682a].powertable_approval_request_rows
