              ...
              CREATE PROCEDURE [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [d0bbf63b-4628-410a-9bfa-7da9e75d682a].powertable_approval_request_rows SET status = 500 FROM [d0bbf63b-4628-410a-9bfa-7da9e75d682a].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
