        ...
        CREATE   PROCEDURE [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [d0bbf63b-4628-410a-9bfa-7da9e75d682a].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [d0bbf63b-4628-410a-9bfa-7da9e75d682a].' + QUOTENAME(@DIVTableName) + ' AS div
