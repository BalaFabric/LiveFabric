      ...
      CREATE   PROCEDURE [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [d0bbf63b-4628-410a-9bfa-7da9e75d682a].[ib_query_writeback] qw
