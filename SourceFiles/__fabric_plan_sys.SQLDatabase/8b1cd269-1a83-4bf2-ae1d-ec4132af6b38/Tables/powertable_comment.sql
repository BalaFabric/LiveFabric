CREATE TABLE [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].[powertable_source] ([id])
);
