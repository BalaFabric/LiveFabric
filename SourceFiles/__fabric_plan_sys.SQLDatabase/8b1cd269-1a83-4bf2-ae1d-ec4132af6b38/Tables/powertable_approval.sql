CREATE TABLE [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].[powertable_source] ([id])
);
