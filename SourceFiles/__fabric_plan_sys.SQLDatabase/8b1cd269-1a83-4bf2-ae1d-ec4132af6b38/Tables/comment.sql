CREATE TABLE [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].[visual] ([id]) ON DELETE CASCADE
);
