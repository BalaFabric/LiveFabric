CREATE TABLE [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].[powertable_approval_request] ([id])
);
