CREATE TABLE [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].[powertable_approval] ([id])
);
