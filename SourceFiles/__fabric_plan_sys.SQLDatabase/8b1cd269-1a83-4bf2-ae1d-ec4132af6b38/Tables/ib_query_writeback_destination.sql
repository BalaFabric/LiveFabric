CREATE TABLE [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].[ib_query_writeback_destination]([queryId] ASC);
