CREATE TABLE [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].[powertable_source] ([id])
);
