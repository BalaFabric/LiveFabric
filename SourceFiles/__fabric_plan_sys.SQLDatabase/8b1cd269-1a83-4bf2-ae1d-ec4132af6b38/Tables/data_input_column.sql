CREATE TABLE [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].[data_input_column] (
    ...
    CONSTRAINT [FK_2f2ba9690ea788805bf78ae17a1] FOREIGN KEY ([visualId]) REFERENCES [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].[visual] ([id])
);
