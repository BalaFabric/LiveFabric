      ...
      CREATE   PROCEDURE [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].[ib_query_writeback] qw
