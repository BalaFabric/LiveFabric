        ...
        CREATE   PROCEDURE [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [8b1cd269-1a83-4bf2-ae1d-ec4132af6b38].' + QUOTENAME(@DIVTableName) + ' AS div
