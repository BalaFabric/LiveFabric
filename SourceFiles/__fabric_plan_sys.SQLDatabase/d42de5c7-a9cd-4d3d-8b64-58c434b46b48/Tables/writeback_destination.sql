CREATE TABLE [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[visual] ([id])
);
