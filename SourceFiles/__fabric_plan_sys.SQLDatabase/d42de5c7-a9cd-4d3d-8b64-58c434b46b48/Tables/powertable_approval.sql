CREATE TABLE [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[powertable_source] ([id])
);
