CREATE TABLE [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[powertable_approval_request] ([id])
);
