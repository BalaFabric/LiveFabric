CREATE TABLE [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[visual] ([id])
);
