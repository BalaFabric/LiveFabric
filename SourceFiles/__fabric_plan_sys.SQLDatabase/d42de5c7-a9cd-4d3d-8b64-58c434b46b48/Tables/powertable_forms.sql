CREATE TABLE [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[powertable_source] ([id])
);
