CREATE TABLE [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[powertable_source] ([id])
);
