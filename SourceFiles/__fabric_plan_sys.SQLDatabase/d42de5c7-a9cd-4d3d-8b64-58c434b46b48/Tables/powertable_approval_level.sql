CREATE TABLE [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[powertable_approval] ([id])
);
