CREATE TABLE [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[powertable_automation_jobs] ([id])
);
