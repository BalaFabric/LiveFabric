CREATE TABLE [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[powertable_approval_request] ([id])
);
