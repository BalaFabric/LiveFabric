CREATE TABLE [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[ib_query_writeback_destination]([queryId] ASC);
