              ...
              CREATE PROCEDURE [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].powertable_approval_request_rows SET status = 500 FROM [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
