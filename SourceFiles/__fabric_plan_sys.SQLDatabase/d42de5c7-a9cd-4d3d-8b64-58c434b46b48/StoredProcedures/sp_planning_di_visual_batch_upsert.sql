        ...
        CREATE   PROCEDURE [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].' + QUOTENAME(@DIVTableName) + ' AS div
