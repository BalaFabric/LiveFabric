      ...
      CREATE   PROCEDURE [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[ib_query_writeback] qw
