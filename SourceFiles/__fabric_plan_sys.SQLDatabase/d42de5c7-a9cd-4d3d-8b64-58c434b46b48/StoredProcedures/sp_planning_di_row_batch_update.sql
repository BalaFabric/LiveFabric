            ...
            CREATE PROCEDURE [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].data_input_row
                INNER JOIN [d42de5c7-a9cd-4d3d-8b64-58c434b46b48].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
