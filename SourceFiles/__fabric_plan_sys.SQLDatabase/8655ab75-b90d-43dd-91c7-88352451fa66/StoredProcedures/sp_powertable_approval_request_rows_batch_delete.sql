              ...
              CREATE PROCEDURE [8655ab75-b90d-43dd-91c7-88352451fa66].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [8655ab75-b90d-43dd-91c7-88352451fa66].powertable_approval_request_rows SET status = 500 FROM [8655ab75-b90d-43dd-91c7-88352451fa66].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
