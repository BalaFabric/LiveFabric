CREATE TABLE [8655ab75-b90d-43dd-91c7-88352451fa66].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [8655ab75-b90d-43dd-91c7-88352451fa66].[visual] ([id])
);
