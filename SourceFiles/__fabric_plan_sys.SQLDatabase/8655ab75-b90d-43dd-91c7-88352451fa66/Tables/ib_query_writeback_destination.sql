CREATE TABLE [8655ab75-b90d-43dd-91c7-88352451fa66].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [8655ab75-b90d-43dd-91c7-88352451fa66].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [8655ab75-b90d-43dd-91c7-88352451fa66].[ib_query_writeback_destination]([queryId] ASC);
