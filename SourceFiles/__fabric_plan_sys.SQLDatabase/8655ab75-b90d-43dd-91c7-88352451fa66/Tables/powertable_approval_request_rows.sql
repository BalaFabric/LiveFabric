CREATE TABLE [8655ab75-b90d-43dd-91c7-88352451fa66].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [8655ab75-b90d-43dd-91c7-88352451fa66].[powertable_approval_request] ([id])
);
