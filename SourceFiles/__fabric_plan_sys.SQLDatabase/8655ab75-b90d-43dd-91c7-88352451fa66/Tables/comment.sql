CREATE TABLE [8655ab75-b90d-43dd-91c7-88352451fa66].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [8655ab75-b90d-43dd-91c7-88352451fa66].[visual] ([id]) ON DELETE CASCADE
);
