CREATE TABLE [8655ab75-b90d-43dd-91c7-88352451fa66].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [8655ab75-b90d-43dd-91c7-88352451fa66].[powertable_source] ([id])
);
