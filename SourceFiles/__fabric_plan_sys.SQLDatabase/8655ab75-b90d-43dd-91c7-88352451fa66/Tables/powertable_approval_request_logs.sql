CREATE TABLE [8655ab75-b90d-43dd-91c7-88352451fa66].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [8655ab75-b90d-43dd-91c7-88352451fa66].[powertable_approval_request] ([id])
);
