CREATE TABLE [8655ab75-b90d-43dd-91c7-88352451fa66].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [8655ab75-b90d-43dd-91c7-88352451fa66].[powertable_source] ([id])
);
