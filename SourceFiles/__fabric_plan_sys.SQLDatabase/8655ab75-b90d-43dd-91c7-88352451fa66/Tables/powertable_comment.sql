CREATE TABLE [8655ab75-b90d-43dd-91c7-88352451fa66].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [8655ab75-b90d-43dd-91c7-88352451fa66].[powertable_source] ([id])
);
