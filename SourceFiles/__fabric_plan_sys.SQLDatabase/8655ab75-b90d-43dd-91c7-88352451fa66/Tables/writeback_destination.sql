CREATE TABLE [8655ab75-b90d-43dd-91c7-88352451fa66].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [8655ab75-b90d-43dd-91c7-88352451fa66].[visual] ([id])
);
