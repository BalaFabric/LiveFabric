CREATE TABLE [8655ab75-b90d-43dd-91c7-88352451fa66].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [8655ab75-b90d-43dd-91c7-88352451fa66].[powertable_source] ([id])
);
