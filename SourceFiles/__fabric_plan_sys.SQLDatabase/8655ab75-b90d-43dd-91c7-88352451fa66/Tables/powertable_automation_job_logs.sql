CREATE TABLE [8655ab75-b90d-43dd-91c7-88352451fa66].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [8655ab75-b90d-43dd-91c7-88352451fa66].[powertable_automation_jobs] ([id])
);
