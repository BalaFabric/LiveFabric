CREATE TABLE [8655ab75-b90d-43dd-91c7-88352451fa66].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [8655ab75-b90d-43dd-91c7-88352451fa66].[powertable_approval] ([id])
);
