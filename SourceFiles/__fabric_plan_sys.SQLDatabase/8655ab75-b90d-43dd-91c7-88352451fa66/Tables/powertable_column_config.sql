CREATE TABLE [8655ab75-b90d-43dd-91c7-88352451fa66].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [8655ab75-b90d-43dd-91c7-88352451fa66].[powertable_source] ([id])
);
