              ...
              CREATE PROCEDURE [b754dc9a-d925-4e21-929d-dc88a0612254].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [b754dc9a-d925-4e21-929d-dc88a0612254].powertable_approval_request_rows SET status = 500 FROM [b754dc9a-d925-4e21-929d-dc88a0612254].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
