CREATE TABLE [b754dc9a-d925-4e21-929d-dc88a0612254].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [b754dc9a-d925-4e21-929d-dc88a0612254].[visual] ([id]) ON DELETE CASCADE
);
