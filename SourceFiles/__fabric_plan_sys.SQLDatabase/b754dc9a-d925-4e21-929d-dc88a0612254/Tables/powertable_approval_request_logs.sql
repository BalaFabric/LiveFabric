CREATE TABLE [b754dc9a-d925-4e21-929d-dc88a0612254].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [b754dc9a-d925-4e21-929d-dc88a0612254].[powertable_approval_request] ([id])
);
