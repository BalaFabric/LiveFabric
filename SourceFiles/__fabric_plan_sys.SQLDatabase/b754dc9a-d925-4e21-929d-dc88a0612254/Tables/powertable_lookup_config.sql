CREATE TABLE [b754dc9a-d925-4e21-929d-dc88a0612254].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [b754dc9a-d925-4e21-929d-dc88a0612254].[powertable_source] ([id])
);
