CREATE TABLE [b754dc9a-d925-4e21-929d-dc88a0612254].[data_input_column] (
    ...
    CONSTRAINT [FK_2f2ba9690ea788805bf78ae17a1] FOREIGN KEY ([visualId]) REFERENCES [b754dc9a-d925-4e21-929d-dc88a0612254].[visual] ([id])
);
