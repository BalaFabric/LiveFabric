CREATE TABLE [b754dc9a-d925-4e21-929d-dc88a0612254].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [b754dc9a-d925-4e21-929d-dc88a0612254].[powertable_source] ([id])
);
