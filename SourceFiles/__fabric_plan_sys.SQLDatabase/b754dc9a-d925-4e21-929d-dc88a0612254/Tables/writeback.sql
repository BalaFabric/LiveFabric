CREATE TABLE [b754dc9a-d925-4e21-929d-dc88a0612254].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [b754dc9a-d925-4e21-929d-dc88a0612254].[visual] ([id])
);
