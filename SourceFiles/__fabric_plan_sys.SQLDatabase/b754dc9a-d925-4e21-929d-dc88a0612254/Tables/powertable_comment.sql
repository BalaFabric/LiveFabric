CREATE TABLE [b754dc9a-d925-4e21-929d-dc88a0612254].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [b754dc9a-d925-4e21-929d-dc88a0612254].[powertable_source] ([id])
);
