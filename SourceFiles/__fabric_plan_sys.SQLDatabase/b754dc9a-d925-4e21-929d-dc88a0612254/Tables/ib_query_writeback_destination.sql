CREATE TABLE [b754dc9a-d925-4e21-929d-dc88a0612254].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [b754dc9a-d925-4e21-929d-dc88a0612254].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [b754dc9a-d925-4e21-929d-dc88a0612254].[ib_query_writeback_destination]([queryId] ASC);
