CREATE TABLE [b754dc9a-d925-4e21-929d-dc88a0612254].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [b754dc9a-d925-4e21-929d-dc88a0612254].[powertable_approval] ([id])
);
