CREATE TABLE [b754dc9a-d925-4e21-929d-dc88a0612254].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [b754dc9a-d925-4e21-929d-dc88a0612254].[powertable_source] ([id])
);
