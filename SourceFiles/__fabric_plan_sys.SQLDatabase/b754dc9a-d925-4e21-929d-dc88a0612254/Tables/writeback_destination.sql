CREATE TABLE [b754dc9a-d925-4e21-929d-dc88a0612254].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [b754dc9a-d925-4e21-929d-dc88a0612254].[visual] ([id])
);
