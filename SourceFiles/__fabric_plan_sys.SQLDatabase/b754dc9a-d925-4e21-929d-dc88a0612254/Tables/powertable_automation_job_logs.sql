CREATE TABLE [b754dc9a-d925-4e21-929d-dc88a0612254].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [b754dc9a-d925-4e21-929d-dc88a0612254].[powertable_automation_jobs] ([id])
);
