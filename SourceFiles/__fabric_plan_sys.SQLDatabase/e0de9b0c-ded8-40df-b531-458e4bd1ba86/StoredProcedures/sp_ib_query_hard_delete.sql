      ...
      CREATE   PROCEDURE [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[ib_query_writeback] qw
