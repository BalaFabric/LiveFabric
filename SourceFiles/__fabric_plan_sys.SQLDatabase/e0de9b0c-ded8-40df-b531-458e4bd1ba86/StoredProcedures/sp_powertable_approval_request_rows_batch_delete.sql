              ...
              CREATE PROCEDURE [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [e0de9b0c-ded8-40df-b531-458e4bd1ba86].powertable_approval_request_rows SET status = 500 FROM [e0de9b0c-ded8-40df-b531-458e4bd1ba86].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
