        ...
        CREATE   PROCEDURE [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [e0de9b0c-ded8-40df-b531-458e4bd1ba86].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [e0de9b0c-ded8-40df-b531-458e4bd1ba86].' + QUOTENAME(@DIVTableName) + ' AS div
