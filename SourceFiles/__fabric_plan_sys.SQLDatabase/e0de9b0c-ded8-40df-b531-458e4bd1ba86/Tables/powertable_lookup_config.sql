CREATE TABLE [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[powertable_source] ([id])
);
