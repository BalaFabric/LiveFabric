CREATE TABLE [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[ib_query_writeback_destination]([queryId] ASC);
