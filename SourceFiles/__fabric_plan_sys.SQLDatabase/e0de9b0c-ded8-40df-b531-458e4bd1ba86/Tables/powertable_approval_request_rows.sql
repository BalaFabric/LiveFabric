CREATE TABLE [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[powertable_approval_request] ([id])
);
