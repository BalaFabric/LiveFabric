CREATE TABLE [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[powertable_source] ([id])
);
