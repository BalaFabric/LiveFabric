CREATE TABLE [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[powertable_source] ([id])
);
