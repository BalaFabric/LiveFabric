CREATE TABLE [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[visual] ([id])
);
