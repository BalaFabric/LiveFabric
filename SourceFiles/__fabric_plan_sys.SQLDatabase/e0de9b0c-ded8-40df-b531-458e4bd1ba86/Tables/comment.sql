CREATE TABLE [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[visual] ([id]) ON DELETE CASCADE
);
