CREATE TABLE [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[powertable_approval_request] ([id])
);
