CREATE TABLE [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[powertable_automation_jobs] ([id])
);
