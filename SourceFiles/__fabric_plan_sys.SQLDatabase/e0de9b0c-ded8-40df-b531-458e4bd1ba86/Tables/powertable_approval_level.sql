CREATE TABLE [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[powertable_approval] ([id])
);
