CREATE TABLE [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [e0de9b0c-ded8-40df-b531-458e4bd1ba86].[powertable_source] ([id])
);
