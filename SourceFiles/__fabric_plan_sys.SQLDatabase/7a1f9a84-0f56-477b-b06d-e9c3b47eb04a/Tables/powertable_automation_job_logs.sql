CREATE TABLE [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].[powertable_automation_jobs] ([id])
);
