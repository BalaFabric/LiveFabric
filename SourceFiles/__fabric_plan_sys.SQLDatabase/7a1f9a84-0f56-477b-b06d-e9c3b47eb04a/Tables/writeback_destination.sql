CREATE TABLE [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].[visual] ([id])
);
