CREATE TABLE [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].[visual] ([id]) ON DELETE CASCADE
);
