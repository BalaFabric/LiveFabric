CREATE TABLE [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].[powertable_source] ([id])
);
