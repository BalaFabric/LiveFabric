CREATE TABLE [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].[data_input_column] (
    ...
    CONSTRAINT [FK_2f2ba9690ea788805bf78ae17a1] FOREIGN KEY ([visualId]) REFERENCES [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].[visual] ([id])
);
