CREATE TABLE [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].[ib_query_writeback_destination]([queryId] ASC);
