      ...
      CREATE   PROCEDURE [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].[ib_query_writeback] qw
