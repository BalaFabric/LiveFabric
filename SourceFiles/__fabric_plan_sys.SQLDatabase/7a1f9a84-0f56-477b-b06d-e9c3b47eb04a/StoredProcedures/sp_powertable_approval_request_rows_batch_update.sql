                          ...
                          CREATE PROCEDURE [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].powertable_approval_request_rows
