        ...
        CREATE   PROCEDURE [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].' + QUOTENAME(@DIVTableName) + ' AS div
