              ...
              CREATE PROCEDURE [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].powertable_approval_request_rows SET status = 500 FROM [7a1f9a84-0f56-477b-b06d-e9c3b47eb04a].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
