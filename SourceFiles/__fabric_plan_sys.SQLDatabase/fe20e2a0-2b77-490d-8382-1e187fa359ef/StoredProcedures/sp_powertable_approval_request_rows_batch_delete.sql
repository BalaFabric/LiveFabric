              ...
              CREATE PROCEDURE [fe20e2a0-2b77-490d-8382-1e187fa359ef].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [fe20e2a0-2b77-490d-8382-1e187fa359ef].powertable_approval_request_rows SET status = 500 FROM [fe20e2a0-2b77-490d-8382-1e187fa359ef].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
