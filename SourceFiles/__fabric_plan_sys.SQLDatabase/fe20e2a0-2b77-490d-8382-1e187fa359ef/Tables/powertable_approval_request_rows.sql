CREATE TABLE [fe20e2a0-2b77-490d-8382-1e187fa359ef].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [fe20e2a0-2b77-490d-8382-1e187fa359ef].[powertable_approval_request] ([id])
);
