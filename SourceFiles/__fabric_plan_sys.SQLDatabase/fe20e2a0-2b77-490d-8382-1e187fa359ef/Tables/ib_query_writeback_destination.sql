CREATE TABLE [fe20e2a0-2b77-490d-8382-1e187fa359ef].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [fe20e2a0-2b77-490d-8382-1e187fa359ef].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [fe20e2a0-2b77-490d-8382-1e187fa359ef].[ib_query_writeback_destination]([queryId] ASC);
