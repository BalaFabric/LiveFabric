CREATE TABLE [fe20e2a0-2b77-490d-8382-1e187fa359ef].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [fe20e2a0-2b77-490d-8382-1e187fa359ef].[visual] ([id]) ON DELETE CASCADE
);
