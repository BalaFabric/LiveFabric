CREATE TABLE [fe20e2a0-2b77-490d-8382-1e187fa359ef].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [fe20e2a0-2b77-490d-8382-1e187fa359ef].[visual] ([id])
);
