CREATE TABLE [fe20e2a0-2b77-490d-8382-1e187fa359ef].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [fe20e2a0-2b77-490d-8382-1e187fa359ef].[visual] ([id])
);
