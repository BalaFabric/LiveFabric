CREATE TABLE [fe20e2a0-2b77-490d-8382-1e187fa359ef].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [fe20e2a0-2b77-490d-8382-1e187fa359ef].[powertable_source] ([id])
);
