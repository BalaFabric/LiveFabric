CREATE TABLE [fe20e2a0-2b77-490d-8382-1e187fa359ef].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [fe20e2a0-2b77-490d-8382-1e187fa359ef].[powertable_approval] ([id])
);
