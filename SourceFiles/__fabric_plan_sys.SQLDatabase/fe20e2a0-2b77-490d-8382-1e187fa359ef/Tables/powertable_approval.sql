CREATE TABLE [fe20e2a0-2b77-490d-8382-1e187fa359ef].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [fe20e2a0-2b77-490d-8382-1e187fa359ef].[powertable_source] ([id])
);
