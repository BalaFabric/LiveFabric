CREATE TABLE [fe20e2a0-2b77-490d-8382-1e187fa359ef].[data_input_column] (
    ...
    CONSTRAINT [FK_2f2ba9690ea788805bf78ae17a1] FOREIGN KEY ([visualId]) REFERENCES [fe20e2a0-2b77-490d-8382-1e187fa359ef].[visual] ([id])
);
