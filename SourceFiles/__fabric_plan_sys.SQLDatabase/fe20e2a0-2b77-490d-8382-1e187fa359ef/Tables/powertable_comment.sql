CREATE TABLE [fe20e2a0-2b77-490d-8382-1e187fa359ef].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [fe20e2a0-2b77-490d-8382-1e187fa359ef].[powertable_source] ([id])
);
