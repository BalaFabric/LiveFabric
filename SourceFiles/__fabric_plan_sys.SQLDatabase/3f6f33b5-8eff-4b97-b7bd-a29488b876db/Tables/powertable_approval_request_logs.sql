CREATE TABLE [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[powertable_approval_request] ([id])
);
