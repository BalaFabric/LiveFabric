CREATE TABLE [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[powertable_approval] ([id])
);
