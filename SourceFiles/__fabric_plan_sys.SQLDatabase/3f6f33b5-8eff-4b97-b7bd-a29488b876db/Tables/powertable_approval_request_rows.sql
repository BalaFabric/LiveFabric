CREATE TABLE [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[powertable_approval_request] ([id])
);
