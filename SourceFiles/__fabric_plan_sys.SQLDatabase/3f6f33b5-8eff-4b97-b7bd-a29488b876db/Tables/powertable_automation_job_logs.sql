CREATE TABLE [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[powertable_automation_jobs] ([id])
);
