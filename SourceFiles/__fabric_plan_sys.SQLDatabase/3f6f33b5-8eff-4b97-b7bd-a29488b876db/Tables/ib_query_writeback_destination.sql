CREATE TABLE [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[ib_query_writeback_destination]([queryId] ASC);
