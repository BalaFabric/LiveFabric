CREATE TABLE [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[powertable_source] ([id])
);
