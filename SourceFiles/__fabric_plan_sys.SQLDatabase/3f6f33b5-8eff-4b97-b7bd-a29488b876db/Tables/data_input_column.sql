CREATE TABLE [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[data_input_column] (
    ...
    CONSTRAINT [FK_2f2ba9690ea788805bf78ae17a1] FOREIGN KEY ([visualId]) REFERENCES [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[visual] ([id])
);
