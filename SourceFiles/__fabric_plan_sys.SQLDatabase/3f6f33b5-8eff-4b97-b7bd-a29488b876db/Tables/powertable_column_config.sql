CREATE TABLE [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[powertable_source] ([id])
);
