CREATE TABLE [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[visual] ([id])
);
