CREATE TABLE [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[powertable_source] ([id])
);
