CREATE TABLE [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[visual] ([id]) ON DELETE CASCADE
);
