CREATE TABLE [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[powertable_source] ([id])
);
