CREATE TABLE [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[powertable_source] ([id])
);
