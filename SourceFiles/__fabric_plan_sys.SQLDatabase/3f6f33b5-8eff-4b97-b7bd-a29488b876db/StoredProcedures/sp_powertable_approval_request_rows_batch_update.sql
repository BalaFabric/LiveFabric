                          ...
                          CREATE PROCEDURE [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [3f6f33b5-8eff-4b97-b7bd-a29488b876db].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [3f6f33b5-8eff-4b97-b7bd-a29488b876db].powertable_approval_request_rows
