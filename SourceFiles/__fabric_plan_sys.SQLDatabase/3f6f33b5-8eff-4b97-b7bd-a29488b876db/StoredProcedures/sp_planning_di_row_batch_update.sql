            ...
            CREATE PROCEDURE [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [3f6f33b5-8eff-4b97-b7bd-a29488b876db].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [3f6f33b5-8eff-4b97-b7bd-a29488b876db].data_input_row
                INNER JOIN [3f6f33b5-8eff-4b97-b7bd-a29488b876db].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
