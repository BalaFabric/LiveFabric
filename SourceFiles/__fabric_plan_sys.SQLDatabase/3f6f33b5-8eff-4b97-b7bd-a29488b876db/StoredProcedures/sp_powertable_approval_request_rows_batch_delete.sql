              ...
              CREATE PROCEDURE [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [3f6f33b5-8eff-4b97-b7bd-a29488b876db].powertable_approval_request_rows SET status = 500 FROM [3f6f33b5-8eff-4b97-b7bd-a29488b876db].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
