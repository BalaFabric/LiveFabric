      ...
      CREATE   PROCEDURE [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[ib_query_writeback] qw
