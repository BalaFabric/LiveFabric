        ...
        CREATE   PROCEDURE [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [3f6f33b5-8eff-4b97-b7bd-a29488b876db].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [3f6f33b5-8eff-4b97-b7bd-a29488b876db].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [3f6f33b5-8eff-4b97-b7bd-a29488b876db].' + QUOTENAME(@DIVTableName) + ' AS div
