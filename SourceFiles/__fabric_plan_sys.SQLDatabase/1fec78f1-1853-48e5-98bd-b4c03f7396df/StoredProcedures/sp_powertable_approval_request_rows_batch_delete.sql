              ...
              CREATE PROCEDURE [1fec78f1-1853-48e5-98bd-b4c03f7396df].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [1fec78f1-1853-48e5-98bd-b4c03f7396df].powertable_approval_request_rows SET status = 500 FROM [1fec78f1-1853-48e5-98bd-b4c03f7396df].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
