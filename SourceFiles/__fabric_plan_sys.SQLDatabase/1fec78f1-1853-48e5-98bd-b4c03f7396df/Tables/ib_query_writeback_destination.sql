CREATE TABLE [1fec78f1-1853-48e5-98bd-b4c03f7396df].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [1fec78f1-1853-48e5-98bd-b4c03f7396df].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [1fec78f1-1853-48e5-98bd-b4c03f7396df].[ib_query_writeback_destination]([queryId] ASC);
