CREATE TABLE [1fec78f1-1853-48e5-98bd-b4c03f7396df].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [1fec78f1-1853-48e5-98bd-b4c03f7396df].[powertable_approval_request] ([id])
);
