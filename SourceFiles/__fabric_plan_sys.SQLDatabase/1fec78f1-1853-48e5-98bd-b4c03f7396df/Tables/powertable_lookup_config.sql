CREATE TABLE [1fec78f1-1853-48e5-98bd-b4c03f7396df].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [1fec78f1-1853-48e5-98bd-b4c03f7396df].[powertable_source] ([id])
);
