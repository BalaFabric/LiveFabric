CREATE TABLE [1fec78f1-1853-48e5-98bd-b4c03f7396df].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [1fec78f1-1853-48e5-98bd-b4c03f7396df].[powertable_source] ([id])
);
