CREATE TABLE [1fec78f1-1853-48e5-98bd-b4c03f7396df].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [1fec78f1-1853-48e5-98bd-b4c03f7396df].[powertable_source] ([id])
);
