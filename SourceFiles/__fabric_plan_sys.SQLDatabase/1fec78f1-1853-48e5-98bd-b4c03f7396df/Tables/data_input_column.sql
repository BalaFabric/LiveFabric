CREATE TABLE [1fec78f1-1853-48e5-98bd-b4c03f7396df].[data_input_column] (
    ...
    CONSTRAINT [FK_2f2ba9690ea788805bf78ae17a1] FOREIGN KEY ([visualId]) REFERENCES [1fec78f1-1853-48e5-98bd-b4c03f7396df].[visual] ([id])
);
