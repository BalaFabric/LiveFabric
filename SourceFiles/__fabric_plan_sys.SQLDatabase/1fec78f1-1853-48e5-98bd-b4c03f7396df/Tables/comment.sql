CREATE TABLE [1fec78f1-1853-48e5-98bd-b4c03f7396df].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [1fec78f1-1853-48e5-98bd-b4c03f7396df].[visual] ([id]) ON DELETE CASCADE
);
