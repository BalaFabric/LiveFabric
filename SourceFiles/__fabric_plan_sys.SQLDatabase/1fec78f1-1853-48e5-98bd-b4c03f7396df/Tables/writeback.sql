CREATE TABLE [1fec78f1-1853-48e5-98bd-b4c03f7396df].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [1fec78f1-1853-48e5-98bd-b4c03f7396df].[visual] ([id])
);
