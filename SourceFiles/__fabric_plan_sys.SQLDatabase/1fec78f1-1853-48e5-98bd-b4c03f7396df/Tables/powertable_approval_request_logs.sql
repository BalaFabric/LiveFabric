CREATE TABLE [1fec78f1-1853-48e5-98bd-b4c03f7396df].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [1fec78f1-1853-48e5-98bd-b4c03f7396df].[powertable_approval_request] ([id])
);
