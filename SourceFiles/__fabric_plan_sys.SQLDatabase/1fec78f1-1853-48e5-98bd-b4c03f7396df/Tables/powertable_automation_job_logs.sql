CREATE TABLE [1fec78f1-1853-48e5-98bd-b4c03f7396df].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [1fec78f1-1853-48e5-98bd-b4c03f7396df].[powertable_automation_jobs] ([id])
);
