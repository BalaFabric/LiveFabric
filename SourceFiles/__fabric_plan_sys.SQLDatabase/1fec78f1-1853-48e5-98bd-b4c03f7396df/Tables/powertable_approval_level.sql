CREATE TABLE [1fec78f1-1853-48e5-98bd-b4c03f7396df].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [1fec78f1-1853-48e5-98bd-b4c03f7396df].[powertable_approval] ([id])
);
